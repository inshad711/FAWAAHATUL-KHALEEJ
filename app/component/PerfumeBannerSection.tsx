...
// // Assuming you have this image asset in your public or assets folder
// // The image shown in the original HTML is "product.png"
// // For demonstration, I'll use a placeholder/relative path.
// // Replace with the actual Next.js Image component and path in a real project.
// const PERFUME_IMAGE_PATH = 'https://aroma-workdo.myshopify.com/cdn/shop/files/product.png?v=1697523457';

// const PerfumeBannerSection: React.FC = () => {
//     return (
//         // Replicating the 'shopify-section product-prescription-section-two' wrapper
//         <section className="py-12 md:py-24 bg-black">
//             <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//                 {/* Replicating the 'row align-items-center' for layout */}
//                 <div className="flex flex-col md:flex-row items-center">

//                     {/* Left Column: Image */}
//                     <div className="w-full md:w-1/2 flex justify-center p-4">
//                         <div className="left-side-image">
//                             {/* NOTE: In a real Next.js project, use the 'next/image' component for optimization */}
//                             <img
//                                 src={PERFUME_IMAGE_PATH}
...
//                     <div className="w-full md:w-1/2 p-4 mt-8 md:mt-0 right-col">
//                         <div className="banner-content-inner text-center md:text-left">

//                             {/* Heading */}
//                             <div className="section-title">
//                                 <h2 className="text-4xl sm:text-5xl font-extrabold leading-tight text-gray-900">
//                                     Modern and trending <br className='hidden sm:block' />
//                                     Perfume for everyone
//                                 </h2>
//                             </div>

//                             {/* Paragraph */}
//                             <p className="mt-4 text-lg text-gray-700 max-w-lg md:max-w-none mx-auto md:mx-0">
//                                 Immerse yourself in a symphony of scents with our exquisite collection of perfumes.
//                                 From alluring florals to seductive orientals and fresh citruses, our fragrances are
//                                 crafted to awaken your senses and leave a lasting impression.
//                             </p>
...
//  shadow-sm text-white bg-gray-900 
...
// export default PerfumeBannerSection;
