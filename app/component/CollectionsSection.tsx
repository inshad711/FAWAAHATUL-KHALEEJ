...
//     return (
//         <section className="primaryBg py-16 text-white">
...
//                 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12 justify-items-center">
//                     {allCollections.map((collection) => (
//                         <div
//                             key={collection.name}
//                             className="flex flex-col items-center group cursor-pointer"
//                         >
//                             <div className="relative mb-4 overflow-hidden rounded-xl shadow-2xl transition-transform duration-300 group-hover:scale-[1.02]">
//                                 <Image
